  ...
  return (
    <ComponentSection>
      <ComponentSectionHeader>
        <ComponentSectionTitle>Logo</ComponentSectionTitle>
        <FigmaLink>
          Figma Link:{" "}
          <Link href="https://www.figma.com/file/oeHqO9qLCkz7SYb73J5Qx4/ReceiverV0-Design-File?node-id=1118%3A14636&t=CRgt5nEaIDw4T45Y-4" target={"_blank"}>
            <span>Logo</span>
          </Link>
        </FigmaLink>
      </ComponentSectionHeader>
