...
const StyledNewMsgInput = styled(NewMsgInput)`
...
export default function NewMessages({hasLoaded, isAddressValid}: { hasLoaded: boolean, isAddressValid: boolean }) {
    ...
    return (
        <Root>
            ...
            <StyledNewMsgInput active={false} isLoading={!hasLoaded} value={"search ENS, LENS or address"}/>
            <Main>
