...
const Svg = styled.svg<{isActive: boolean}>`
...
export const Edit = ({isActive}: {isActive: boolean}) => {
    return (
        <Svg isActive={isActive} width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
