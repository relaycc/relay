...
import { IconChevronDown } from "@/design/relay/IconChevronDown";
import { receiverTheme } from "@/design/receiverTheme";
import * as DropdownItem from "@/design/relay/DropdownItem";
import { useState } from "react";
import { DropdownItemRoot } from "@/design/relay/DropdownItem";

export * as DropdownItem from "@/design/relay/DropdownItem";
...
export const DropdownItemContainer = styled(DropdownItemRoot)<{
  open: boolean;
}>`
    ...
    <Root>
      ...
      <DropdownItemContainer open={open}>
        {CommunityLinks.map((i: string, index) => (
          <DropdownItem.DropdownItemText key={index} onClick={() => close()}>
            {i}
          </DropdownItem.DropdownItemText>
        ))}
