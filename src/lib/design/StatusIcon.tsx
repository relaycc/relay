...
export const StatusIcon = ({size, isLoading}: {size: string, isLoading:boolean}) => {
    ...
    return(
        ...
        isLoading ?
            ...
            :
            <Svg size={size} width="40" height="40" viewBox="0 0 40 40" fill="none"
                    ...
                    <defs>
                        ...
                        <image id="image0_454_10832" width="64" height="64"
